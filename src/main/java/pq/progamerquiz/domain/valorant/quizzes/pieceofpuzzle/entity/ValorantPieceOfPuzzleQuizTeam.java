...
public class ValorantPieceOfPuzzleQuizTeam {
    ...
    private ValorantPieceOfPuzzle pieceofpuzzle;
    ...
    private ValorantPieceOfPuzzleQuizTeam(ValorantPieceOfPuzzle pieceofpuzzle, TeamValorant teamValorant, ProgamerValorant progamerValorant) {
        this.pieceofpuzzle = pieceofpuzzle;
        this.teamValorant = teamValorant;
        this.progamerValorant = progamerValorant;
    }

    public static ValorantPieceOfPuzzleQuizTeam create(ValorantPieceOfPuzzle pieceOfPuzzle, TeamValorant teamValorant, ProgamerValorant progamerValorant) {
