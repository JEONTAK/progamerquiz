...
import pq.progamerquiz.domain.leagueoflegends.quizzes.whichisteam.dto.request.WhichIsTeamSaveResultRequest;
import pq.progamerquiz.domain.leagueoflegends.quizzes.whichisteam.dto.request.WhichIsTeamStartRequest;
import pq.progamerquiz.domain.leagueoflegends.quizzes.whichisteam.dto.request.WhichIsTeamSubmitAnswerRequest;
...
public class ValorantWhichIsTeamController {
    ...
    @ResponseBody
    public ResponseEntity<ValorantWhichIsTeamResponse> setQuiz(@RequestBody WhichIsTeamStartRequest request) {
        log.info("[Which Is Team] Request size : " + request.getTotalQuizCount());
        log.info("[Which Is Team] Set Quiz...");
        List<ValorantWhichIsTeamQuizResponse> quizList = whichIsTeamService.setQuizLists(request.getTotalQuizCount());
    ...
    @ResponseBody
    public ResponseEntity<ValorantWhichIsTeamSubmitAnswerResponse> submitAnswer(@RequestBody WhichIsTeamSubmitAnswerRequest request) {
    ...
    @PostMapping("/end")
    @ResponseBody
    public ResponseEntity<ValorantWhichIsTeamResultResponse> quizEnd(@RequestBody WhichIsTeamSaveResultRequest request) {
