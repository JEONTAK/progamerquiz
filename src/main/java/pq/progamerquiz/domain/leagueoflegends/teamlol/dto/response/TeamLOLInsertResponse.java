...
public class TeamLOLInsertResponse {
    ...
    private TeamLOLInsertResponse(Long id, String name, String callName, Long seasonYear, String league, Long springRank, Long summerRank, Long msiRank, Long worldsRank, Long winterRank, Long imageId) {
        this.id = id;
        this.name = name;
    ...
    public static TeamLOLInsertResponse create(TeamLOL teamLOL) {
        return new TeamLOLInsertResponse(
