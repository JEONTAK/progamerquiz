...
public class WhoAreYou extends BaseEntity {
    ...
    private WhoAreYou(Long attempt, boolean correct, ProgamerLOL quizProgamerLOL) {
        this.attempt = attempt;
        this.correct = correct;
        this.quizProgamerLOL = quizProgamerLOL;
    }

    public static WhoAreYou create(Long attempt, boolean correct, ProgamerLOL quizProgamerLOL) {
        return new WhoAreYou(attempt, correct, quizProgamerLOL);
    }
