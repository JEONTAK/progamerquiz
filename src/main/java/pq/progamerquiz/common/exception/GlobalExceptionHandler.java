package pq.progamerquiz.common.exception;
...
import pq.progamerquiz.common.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    private ResponseEntity<ErrorResponse> getErrorResponse(HttpStatus status, String message) {
        ErrorResponse response = ErrorResponse.of(status.name(), status.value(), message, LocalDateTime.now());
